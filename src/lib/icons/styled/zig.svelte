...
<svg class={className} viewBox="0 0 200 200" fill="none" xmlns="http://www.w3.org/2000/svg">
	...
	<defs>
		...
		<clipPath id="clip0_238_1296"> <rect width="200" height="200" fill="white" /> </clipPath>
	</defs>
</svg>
